...
const _parseStopsListData = _api.__get__('parseStopsListData');
const _fetchStopsListData = _api.__get__('fetchStopsListData');
const _fetchStopData = _api.__get__('fetchStopData');
const _parseStop = _api.__get__('parseStop');
const _getData = _api.__get__('getData');
const _getNearbyLocations = _api.__get__('getNearbyLocations');
...
const check6509 = fs.readFileSync('./test/data/bh/6509.txt', 'utf8');
const check65097 = fs.readFileSync('./test/data/bh/6509-7.txt', 'utf8');
...
const content6509777 = fs.readFileSync('./test/data/bh/6509-777.html', 'utf8');
